        ...
        <section className="flex flex-row justify-center items-center w-full min-h-[90vh] gap-20">
            ...
            <div className="flex flex-col w-9/20 gap-8">
                ...
                <h1 className="text-5xl font-semibold">
                    Raih Peluang Sukses dengan Tes TOEFL yang <span className="text-red-600">Asik</span> & <span className="text-red-600">Sat-Set</span>!
                </h1>
                ...
                <Link href="/test" className="bg-amber-500 text-xl text-white font-medium px-6 py-3 rounded-xl w-fit hover:bg-red-600 hover:text-white transition-colors duration-300">
                    Coba Tes Sekarang
                </Link>
            </div>
        </section>
